...
class Seqgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = 'save/oracle_g0d0.txt'
        self.generator_file = 'save/generator_g0d0.txt'
        self.test_file = 'save/test_file_g0d0.txt'
    ...
    def train_real(self, data_loc=None):
        ...
        self.adversarial_epoch_num = 70
        self.log = open('experiment-log-seqgan-real_g0d0.csv', 'w')
        generate_samples(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
        self.gen_data_loader.create_batches(self.oracle_file)
