...
class CSeqgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = 'save/oracle_g3d2.txt' #ground truth file
        self.generator_file = 'save/generator_g3d2.txt'
        self.test_file = 'save/test_file_g3d2.txt'
    ...
    def train_real(self, data_loc=None):
        ...
        self.log = open('experiment-log-cseqgan-real_g3d2.csv', 'w')
        generate_samples(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
