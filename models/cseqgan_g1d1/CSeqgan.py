...
from models.Gan_g1d1 import Gan
from models.cseqgan_g1d1.CSeqganDataLoader import DataLoader, DisDataloader
from models.cseqgan_g1d1.CSeqganDiscriminator import Discriminator
from models.cseqgan_g1d1.CSeqganGenerator import Generator
from models.cseqgan_g1d1.CSeqganReward import Reward
...
class CSeqgan(Gan):
    ...
    def init_real_trainng(self, save_dir, data_loc=None):
        ...
        discriminator = Discriminator(sequence_length=self.sequence_length+1, num_classes=2, vocab_size=self.vocab_size,
        ...
        dis_dataloader = DisDataloader(batch_size=self.batch_size, seq_length=self.sequence_length+1)
