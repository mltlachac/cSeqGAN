...
from models.Gan_g0d0 import Gan
from models.seqgan_pos.SeqganDataLoader import DataLoader, DisDataloader
from models.seqgan_pos.SeqganDiscriminator import Discriminator
from models.seqgan_pos.SeqganGenerator import Generator
from models.seqgan_pos.SeqganReward import Reward
from utils.metrics.Cfg import Cfg
from utils.metrics.EmbSim import EmbSim
from utils.metrics.Nll_g0d0 import Nll
from utils.oracle.OracleCfg import OracleCfg
from utils.oracle.OracleLstm import OracleLstm
from utils.text_process import *
from utils.utils_g0d0 import *
...
class Seqgan(Gan):
    ...
    def init_real_trainng(self, save_dir, data_loc=None):
        ...
        self.sequence_length, self.vocab_size = text_precess(data_loc, save_dir)
        generator = Generator(num_vocabulary=self.vocab_size, batch_size=self.batch_size, emb_dim=self.emb_dim,
                              hidden_dim=self.hidden_dim, sequence_length=self.sequence_length,
                              start_token=self.start_token)
        self.set_generator(generator)
    ...
    def init_real_metric(self, data_loc):
        from utils.metrics.DocEmbSim import DocEmbSim
        docsim = DocEmbSim(oracle_file=self.oracle_file, generator_file=self.generator_file, num_vocabulary=self.vocab_size)
        self.add_metric(docsim)
    ...
    def train_real(self, data_loc=None, save_dir='./save'):
        ...
        log_file_path = save_dir + '/experiment-log-seqgan-real.csv'
