...
from models.Gan_g3d2 import Gan
from models.cseqgan_g3d2.CSeqganDataLoader import DataLoader, DisDataloader
from models.cseqgan_g3d2.CSeqganDiscriminator import Discriminator
from models.cseqgan_g3d2.CSeqganGenerator import Generator
from models.cseqgan_g3d2.CSeqganReward import Reward
...
class CSeqgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = '' #ground truth file
        self.generator_file = ''
        self.test_file = ''
    ...
    def train_discriminator(self):
        ...
        for _ in range(3):
            ...
            x_batch, y_batch, seq_label= self.dis_data_loader.next_batch()
            feed = {
                self.discriminator.input_x: x_batch,
                self.discriminator.input_y: y_batch,
                self.discriminator.label: seq_label
            }
    ...
    def init_real_trainng(self, save_dir, data_loc=None):
        ...
        self.sequence_length, self.vocab_size, labels = csv_text_precess(data_loc, save_dir) #KratikaA: getting labels as well for all training inputs
        ...
        dis_dataloader = DisDataloader(batch_size=self.batch_size, seq_length=self.sequence_length, n_classes=self.n_classes)
        ...
        self.oracle_file = save_dir + '/oracle.txt'
    ...
    def train_real(self, data_loc=None, save_dir='./save'):
        from utils.text_process import code_to_text
        from utils.text_process import get_tokenlized
        self.generator_file = save_dir + '/generator.txt'
        self.test_file = save_dir + '/test_file.txt'

        wi_dict, iw_dict = self.init_real_trainng(save_dir, data_loc)
        ...
        log_file_path = save_dir + '/experiment-log-cseqgan-real.csv'
